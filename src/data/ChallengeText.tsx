export const challengeStrs = [
  ...
  },
  {
    id: 3, 
    title: 'FizzBuzz 問題', 
    description: '1 から指定された数までの FizzBuzz 配列を返す関数 fizzBuzz を実装してください。 FizzBuzz 配列とは、3 の倍数で「Fizz」、5 の倍数で「Buzz」、両方の倍数で「FizzBuzz」、それ以外はそのまま数値を出力します。', 
